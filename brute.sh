...
echo -e '''
   ...
   \e[1;37m[\e[1;31m Contact \e[1;31m:\e[1;34m Hacker Squade[1;37m ]
...
# asking
echo -ne "${white}[ ${red}?${white} ] Choose what you want bro ${red}:${green} " ; read ask_menu
...
case $ask_menu in
	...
	3 ) # menu 3
		...
		;;
	* ) # wrong menu
		echo -e "${white}[ ${red}ERROR${white} ] ${red}:${white} Option not on menu bro..."
		sleep 2
		clear
		bash brute.sh
		;;
